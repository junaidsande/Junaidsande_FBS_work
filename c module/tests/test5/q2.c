//Q2 wap to initialize some amount in your account . then give choice to user to use for deposit
//or withdrow and display updated amount . condition to withdrow (if the balamce is less than 3000
